...
import quantum from "@/assets/trend-quantum.jpg";
import philosophy from "@/assets/trend-philosophy.jpg";
import global from "@/assets/trend-global.jpg";

const items = [
  { img: human, tag: "Anthropology", title: "The Human Matrix" },
  { img: quantum, tag: "Quantum", title: "Entangled Realities" },
  { img: philosophy, tag: "Philosophy", title: "Quietude of Mind" },
  { img: global, tag: "Cybernetics", title: "Global Synapse" },
];
