...
const genreDescriptions: Record<string, string> = {
  ...
  Classics: "Public-domain novels that still shape how modern readers think about character and society.",
  Adventure: "Maps, voyages, risk, pursuit, and stories built around courage under pressure.",
  "Science Fiction": "Speculative machines, invasions, futures, and the social questions hidden inside wonder.",
  Fantasy: "Impossible worlds, strange logic, quests, and imagination that tests ordinary rules.",
  "Political Philosophy": "Power, rule, civic order, and the difficult choices behind public life.",
  "Children's Classics": "Enduring stories for younger readers, rich with danger, play, and moral growth.",
  "Gothic Horror": "Atmosphere, secrecy, dread, and old fears crossing into modern rooms.",
